...
@interface TB_Permiss()<UIAlertViewDelegate>

@end

@implementation TB_Permiss


+(TB_Permiss*)sharePermiss
{
    static TB_Permiss *miss=nil;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        miss=[[TB_Permiss alloc]init];
    });
